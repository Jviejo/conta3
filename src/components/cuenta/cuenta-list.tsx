...
export async function CuentaList({ companyId, exerciseYear }: CuentaListProps) {
  const cuentas = await getCuentas(companyId, exerciseYear);
              ...
              <TableCell className="text-right">
                <div className="flex justify-end gap-2">
                  <form action={deleteCuenta}>
                    <input type="hidden" name="id" value={cuenta._id?.toString()} />
